...
interface ForStatement<T extends Init, U extends Test, V extends Update>
...
function extractInit(path: NodePath<t.ForStatement>) {
  let changed = false;
...
function emptyUpdate(
  path: NodePath<
    ForStatement<null | undefined, NonNullable<Test>, null | undefined>
  >,
) {
...
export default function (path: NodePath<t.ForStatement>) {
